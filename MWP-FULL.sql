...
BEGIN
	...
	LEFT JOIN mwp_threadcategory thcat ON thcat.threadcategoryname = 'Events Discussions'
    LEFT JOIN MWP.MWP_THREADABLE curr ON prev.THREAD_ID = curr.TEMP_ID  AND curr.THREADCATEGORYID = thcat.threadcategoryid
